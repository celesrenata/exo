...
def test_configuration():
    ...
    try:
        ...
        checks = [
            ...
            ("EXO_RUNNER_HEALTH_CHECK_INTERVAL", EXO_RUNNER_HEALTH_CHECK_INTERVAL, float, 0.0),
            ...
            ("EXO_RUNNER_ENABLE_ENHANCED_LOGGING", EXO_RUNNER_ENABLE_ENHANCED_LOGGING, bool, None)
        ]
