...
EXO_RUNNER_SHUTDOWN_TIMEOUT = float(
    os.environ.get("EXO_RUNNER_SHUTDOWN_TIMEOUT", "60.0")
)
EXO_RUNNER_HEALTH_CHECK_INTERVAL = float(
    os.environ.get("EXO_RUNNER_HEALTH_CHECK_INTERVAL", "30.0")
)
...
EXO_RUNNER_MAX_STARTUP_RETRIES = int(
    os.environ.get("EXO_RUNNER_MAX_STARTUP_RETRIES", "3")
)
EXO_RUNNER_ENABLE_ENHANCED_LOGGING = (
    os.environ.get("EXO_RUNNER_ENABLE_ENHANCED_LOGGING", "true").lower() == "true"
)
