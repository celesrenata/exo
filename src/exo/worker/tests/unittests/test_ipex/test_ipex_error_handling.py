...
class TestIPEXErrorContext:
    ...
    def test_get_ipex_error_context_base_error(self):
        ...
        with patch('exo.worker.engines.ipex.utils_ipex.get_intel_gpu_info') as mock_info:
    ...
    def test_get_ipex_error_context_info_failure(self):
        ...
        with patch('exo.worker.engines.ipex.utils_ipex.get_intel_gpu_info', 
...
class TestIPEXMemoryManagement:
    ...
    def test_optimize_intel_gpu_memory_usage_success(self):
        ...
        with patch('gc.collect') as mock_gc, \
             ...
             patch('exo.worker.engines.ipex.utils_ipex.clear_intel_gpu_memory') as mock_clear:
    ...
    def test_handle_intel_gpu_memory_error_recovery_success(self):
        ...
        with patch('exo.worker.engines.ipex.utils_ipex.get_intel_gpu_memory_usage') as mock_memory, \
             patch('exo.worker.engines.ipex.utils_ipex.optimize_intel_gpu_memory_usage') as mock_optimize:
    ...
    def test_handle_intel_gpu_memory_error_exception_during_recovery(self):
        ...
        with patch('exo.worker.engines.ipex.utils_ipex.get_intel_gpu_memory_usage', 
