...
class TestManagedChannel:
    ...
    def test_get_sender_inactive_channel(self, mock_channel_creation):
        ...
        with pytest.raises(RuntimeError, match="Cannot get sender for channel test_channel in state"):
            channel.get_sender()
    ...
    def test_get_receiver_inactive_channel(self, mock_channel_creation):
        ...
        with pytest.raises(RuntimeError, match="Cannot get receiver for channel test_channel in state"):
...
class TestChannelManager:
    ...
    def manager(self, resource_manager):
        ...
        with patch('exo.worker.runner.channel_manager.SharedStateManager'), \
    ...
    async def test_health_check(self, manager, mock_channel_creation):
        ...
        channel1 = await manager.create_channel("healthy_channel")
